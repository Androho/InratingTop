package io.github.androho.inratingtop.apiservise;
...
public interface GetResponseServiceCommentators {
    ...
    Observable<GetAllCommentators> getCommentatorsData(@Query("id") Integer id) ;
}
